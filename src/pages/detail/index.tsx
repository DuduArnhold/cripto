...
export function Detail(){
    ...
    useEffect(() => {
        function getData(){
            fetch(`https://sujeitoprogramador.com/api-cripto/coin/?key=ed25652a6ce4bc0e&symbol=${cripto}`)
        ...
        <div className={styles.container}>
            ...
            <section className={styles.content}>
                ...
                <p>
                    ...
                    <span className={Number(detail?.delta_24h.replace(",", ".")) >= 0 ? styles.profit : styles.loss}>{detail?.delta_24h}</span>
                </p>
